...
public class LibroServicio {
    ...
    @Transactional
    public void registrar(Long isbn, String titulo, Integer anio, Integer ejemplares, Integer ejemplaresPrestados, String idAutor, String idEditorial) throws ErrorServicio {
    ...
    private void validar(Long isbn, String titulo, Integer anio, Integer ejemplares, Integer ejemplaresPrestados, Autor autor, Editorial editorial) throws ErrorServicio {
        if (isbn < 100000000000L || isbn > 9999999999999L) {
            throw new ErrorServicio("El isbn del libro debe contener 13 numeros");
        }
